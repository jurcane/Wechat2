...
class WxApiModel{
    ...
    public function getUserInfo($access_token, $openid){
        ...
        $wx_user_json = file_get_contents("https://api.weixin.qq.com/cgi-bin/user/info?access_token=".$access_token."&openid=".$openid."&lang=zh_CN");
        $wx_res = json_decode($wx_user_json,true);
        return $wx_res;
    }
    ...
    public function getAccessToken($appid = '', $secret = ''){
        ...
        $wx_json = file_get_contents("https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=".$appid."&secret=".$secret);
