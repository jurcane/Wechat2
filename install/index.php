...
//----------------------语言包
$lang = array(
'license'=>'<div class="license"><h1>Hello World</h1>
                <p>版权所有 (c)2016-2017 保留所有权利。 </p>
				<p>我其实最讨厌写各种说明了。</p>
				<p><b>版本最新更新：</b> 2016年04月21日</p>
                <p align=right>BY Jack</p>
</div>',
...
$dirfile_items = array(
    'conf' => array('type' => 'file', 'path' => '/Application/Common/Conf/db.php'),
);
...
if($method == 'show_license') {//声明
	...
	if($submit) {
      ...
      $password = md5($password);
			$db->query("INSERT INTO `{$tablepre}admin` (`id`, `username`, `password`, `status`, `last_login_time`, `last_login_ip`) VALUES
(1, '".$username."', '".$password."', 1, ".time().", '127.0.0.1')");
			//新增一个标识文件，用来屏蔽重新安装
...
?>
			<div class="footer">
			    <p>Powered by NWC(c) v9.1 2015-2016</p>
				<p>版权所有</p>
			</div>
		</div>
		</div>
